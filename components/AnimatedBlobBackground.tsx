...
export default function AnimatedBlobBackground() {
  ...
  const generateBlobPath = (time: number, index: number): string => {
    const numPoints = 12;
    ...
    for (let i = 0; i <= numPoints; i++) {
      ...
      // Create smooth, organic variation
      ...
      if (i === 0) {
        ...
        // Use smooth curves for more liquid-like appearance
      ...
      >
        ...
        <defs>
          ...
          <linearGradient id="gradient3" x1="50%" y1="100%" x2="50%" y2="0%">
            ...
            <stop offset="50%" stopColor="#3ECF8E" stopOpacity="0.3" />
