        ...
        <Container maxW="4xl" py={4}>
          <Flex justify="space-between" align="center">
            <HStack spacing={4}>
              ...
              <HStack spacing={2}>
                <svg width="28" height="28" viewBox="0 0 48 48" fill="none" aria-label="suparbase logo" role="img">
                  <title>suparbase logo</title>
                  <defs>
      ...
      <Container maxW="4xl" py={8}>
        {isLoading && !status ? (
          ...
          <VStack spacing={6} align="stretch">
            ...
            <Card bg="surface.800" borderColor="surface.700">
              <CardBody>
                <Heading as="h2" size="sm" color="white" mb={4}>Configured Connections</Heading>
