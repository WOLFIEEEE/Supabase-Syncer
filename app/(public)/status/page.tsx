                          ...
                          >
                            <Box width="36px" height="36px" position="relative">
                              ...
                              >
                                ...
                                <rect x="10" y="8" width="4" height="32" rx="2" fill="url(#electricGradStat)" />
                                <rect x="10" y="8" width="20" height="4" rx="2" fill="url(#electricGradStat)" />
                                <rect x="10" y="20" width="14" height="4" rx="2" fill="url(#electricGradStat)" />
                                <path
                                  d="M 14 24 L 28 40"
